...
const ProductSchema = CollectionSchema(
  ...
  properties: {
    r'compatibleList': PropertySchema(
      id: 0,
      name: r'compatibleList',
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'Compatible': CompatibleSchema},
  getId: _productGetId,
...
int _productEstimateSize(
  ...
  bytesCount += 3 + object.compatibleList.length * 3;
  {
    final offsets = allOffsets[Compatible]!;
    for (var i = 0; i < object.compatibleList.length; i++) {
      final value = object.compatibleList[i];
      bytesCount += CompatibleSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
void _productSerialize(
  ...
  writer.writeObjectList<Compatible>(
    offsets[0],
    allOffsets,
    CompatibleSchema.serialize,
    object.compatibleList,
  );
...
Product _productDeserialize(
  ...
  object.compatibleList = reader.readObjectList<Compatible>(
        offsets[0],
        CompatibleSchema.deserialize,
        allOffsets,
        Compatible(),
      ) ??
      [];
...
P _productDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectList<Compatible>(
            offset,
            CompatibleSchema.deserialize,
            allOffsets,
            Compatible(),
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition>
      compatibleListLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition>
      compatibleListLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQueryObject
    on QueryBuilder<Product, Product, QFilterCondition> {
  QueryBuilder<Product, Product, QAfterFilterCondition> compatibleListElement(
      FilterQuery<Compatible> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'compatibleList');
    });
  }
}
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, List<Compatible>, QQueryOperations>
      compatibleListProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'compatibleList');
    });
  }
...
const CompatibleSchema = Schema(
  ...
  estimateSize: _compatibleEstimateSize,
  serialize: _compatibleSerialize,
  deserialize: _compatibleDeserialize,
  deserializeProp: _compatibleDeserializeProp,
);

int _compatibleEstimateSize(
  Compatible object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
void _compatibleSerialize(
  ...
  writer.writeString(offsets[1], object.producer);
}

Compatible _compatibleDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = Compatible();
  object.model = reader.readStringOrNull(offsets[0]);
  object.producer = reader.readStringOrNull(offsets[1]);
  return object;
}

P _compatibleDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension CompatibleQueryFilter
    on QueryBuilder<Compatible, Compatible, QFilterCondition> {
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> modelIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'model',
        value: '',
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition>
      modelIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'model',
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> producerIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'producer',
      ));
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> producerEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> producerLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> producerBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> producerEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> producerContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Compatible, Compatible, QAfterFilterCondition> producerMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension CompatibleQueryObject
    on QueryBuilder<Compatible, Compatible, QFilterCondition> {}
